...
__Note:__ We depend on Node.js >=24 for [SQLite support](https://nodejs.org/docs/latest/api/sqlite.html) in a [long term support (LTS) version](https://nodejs.org/en/about/previous-releases).

__Note:__ Support is planned for deployment targets to [Deno](https://deno.com/), [Cloudflare Workers](https://workers.cloudflare.com/product/workers/), and [AWS Lambda](https://aws.amazon.com/lambda/).
