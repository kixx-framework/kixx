...
- [x] **Define the invalid-cursor storage error**
...
- [x] **Configure a runtime cursor-signing secret**
...
- [x] **Seal and unseal cursors in the DocumentStore facade**
...
- [x] **Preserve cursor failures through list transaction scripts**
...
- [x] **Validate URL cursor and invite-history input at the presentation boundary**
...
- [x] **Document the signed public cursor contract**
...
- [x] **Lint the changed source files**
