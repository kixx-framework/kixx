...
- [x] **Add JSON:API presentation helpers**
...
- [x] **Add the JSON:API error handler**
  - **Story**: XS-1
...
- [x] **Extract a no-session admin account creation Transaction Script**
  - **Story**: AS-1
...
- [x] **Extract a no-session admin credential verification Transaction Script**
  - **Story**: AS-2
...
- [x] **Add a JSON:API constructor to NewAdminUserForm**
  - **Story**: AS-1
...
- [x] **Add the accept-invite Admin API request handler**
  - **Story**: AS-1
...
- [x] **Add the PublishingApiToken collection and record**
  - **Story**: AS-2, PS-1
...
- [x] **Register the PublishingApiToken collection**
  - **Story**: AS-2, PS-1
...
- [x] **Add the publishing permissions library**
  - **Story**: AS-2, PS-1
...
- [x] **Add the CreatePublishingApiTokenForm**
  - **Story**: AS-2
...
- [x] **Add the create-publishing-api-token Transaction Script**
  - **Story**: AS-2
...
- [x] **Add the create-publishing-api-token Admin API request handler**
  - **Story**: AS-2
...
- [x] **Add the authenticate-publishing-token Transaction Script**
  - **Story**: PS-1
...
- [x] **Add the publishing-token authentication middleware**
  - **Story**: PS-1
...
- [x] **Add the put-template Transaction Script**
  - **Story**: PS-2
...
- [x] **Add the template PUT request handlers and helper**
  - **Story**: PS-2
...
- [x] **Add the put-page-metadata Transaction Script**
  - **Story**: PS-3
...
- [x] **Add the page-metadata PUT request handler**
  - **Story**: PS-3
...
- [x] **Add the put-include Transaction Script**
  - **Story**: PS-4
...
- [x] **Add the include PUT request handler**
  - **Story**: PS-4
...
- [x] **Wire the Admin API and Publishing API routes into virtual-hosts**
