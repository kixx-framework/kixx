...
description: Guidelines for documenting JavaScript code in this project, covering both JSDoc block comments for formal API contracts and inline comments for explaining intent, context, and non-obvious decisions. Apply this skill when writing, refactoring, or reviewing JavaScript code.
---
