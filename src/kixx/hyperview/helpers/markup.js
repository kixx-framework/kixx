 ...
 *
 * A non-string value is not an error: it is formatted for diagnostics and
 * rendered in place, so a page with a mistyped field still renders and shows
 * what it received.
 ...
 * @returns {string} Rendered HTML, an empty string for empty input, or a diagnostic string for a non-string value
