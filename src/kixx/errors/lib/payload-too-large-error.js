...
/**
 * Error used when a request payload exceeds the size the server will accept.
 * @extends WrappedError
 */
export default class PayloadTooLargeError extends WrappedError {
    /**
     ...
     * @readonly
     */
    static CODE = 'PAYLOAD_TOO_LARGE_ERROR';

    /**
     * The HTTP status code for this error type (413).
     * @type {number}
     * @static
     * @readonly
     */
    static HTTP_STATUS_CODE = 413;

    /**
     * @param {string} message - Error message describing the oversized payload.
