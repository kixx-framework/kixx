 ...
 * filesystem paths are namespaced as `{directory}/{namespace}/{prefix}{filepath}`
 ...
 * stored at the flat `{directory}/{prefix}{filepath}` — which supports use cases
...
export default class TemplateFileStore {
     ...
     * @param {Object} _context - Ignored; present for TemplateFileStoreInterface compatibility
     ...
     * `{directory}/{namespace}/{barePrefix}{filepath}` encoding shared by the
