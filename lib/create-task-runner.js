...
const {append, assoc, complement, difference, has, isFunction} = require(`../library`);
...
module.exports = defineFunction({
	...
	params: [],
	func: function createTaskRunner(options, filename, taskName) {
		...
		function walkTaskDefinitions(taskRunners, taskName) {
			...
			return append(taskRunners, invokeTask);
		}
		...
		return new Promise((resolve, reject) => {
			...
			return composeMiddleware(functions, onComplete)(Object.create(null));
		});
	}
});
