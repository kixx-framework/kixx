...
import NodeConfigStore from '../config-store/node-config-store.js';
...
export default class NodeBootstrap {
    ...
    /**
     * Returns the Node.js platform utilities implementing the UUIDGenerator port.
     * @public
     * @returns {import('../../ports/uuid-generator.js').UUIDGenerator}
     */
    createUtils() {
        return utils;
    }
