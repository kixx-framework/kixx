...
export default class NodeServer {
    ...
    /**
     * Closes the underlying Node.js HTTP server, stopping it from accepting new connections.
     * Existing connections are allowed to finish. Emits 'server-closed' info event when done.
     * @public
     * @returns {void}
     * @throws {AssertionError} When the server has not been started
     */
    close() {
        if (!this.#nodeServer) {
            throw new AssertionError('Server has not been started');
        }
