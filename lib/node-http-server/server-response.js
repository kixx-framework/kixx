...
export default class ServerResponse {
    ...
    constructor(id) {
        ...
        /**
         * Response body: string, Buffer, Readable stream, etc.
         * @type {string|Buffer|import('stream').Readable|null}
         */
        this.body = null;
     ...
     * @param {import('stream').Readable|null} readStream - Readable stream to pipe, or null for HEAD responses
     * @param {Object} [options]
