...
/**
 * Wraps a Node.js IncomingMessage to provide a Web API-compatible HTTP request interface.
 *
 * Exposes parsed request metadata (method, URL, headers, cookies, and route parameters) as
 * synchronous properties, and body-consuming methods (json(), formData()) that read from
 * the Web API ReadableStream. Designed for use within the Kixx router pipeline.
 */
export default class ServerRequest {
    ...
    isJSONRequest() {
        ...
        // Accept header is the HTTP-defined mechanism for requesting a response format
