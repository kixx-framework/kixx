 ...
 * @property {function(string): Promise<boolean>} doesPageExist - Checks whether a page exists for a pathname
 * @property {function(string): Promise<Object>} getPageData - Loads page data for a pathname
 * @property {function(string, Object=): Promise<HyperviewSourceFile|null>} getPageTemplate - Loads a page template source file
 * @property {function(string): Promise<HyperviewSourceFile[]>} getMarkdownContent - Loads markdown source files for a page
 */

/**
 * @typedef {Object} HyperviewTemplateStore
 * @property {function(string): Promise<HyperviewSourceFile|null>} getBaseTemplate - Loads a base template source file
 * @property {function(): Promise<HyperviewSourceFile[]>} loadPartialFiles - Loads partial template source files
 * @property {function(): Promise<HyperviewHelperFile[]>} loadHelperFiles - Loads custom template helpers
 */

/**
 * @typedef {Object} HyperviewTemplateEngine
 * @property {function(string, string, Map<string, Function>, Map<string, Function>): Function} compileTemplate - Compiles template source into a render function
 */

/**
 * @typedef {Object} HyperviewStaticFileServerStore
 * @property {function(string): Promise<Object|null>} getFile - Loads a static file by pathname
 */
...
export default class HyperviewService {
     ...
     * Includes built-in helpers (formatDate, markup, truncate) and custom helpers loaded from files
