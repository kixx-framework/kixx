import { KixxTemplating } from '../vendor/mod.js';

const { tokenize, buildSyntaxTree, createRenderFunction, helpers } = KixxTemplating;
 ...
 * output strings.
 *
 * @see {import('../ports/hyperview-template-engine.js').HyperviewTemplateEngine} HyperviewTemplateEngine port
 */
export default class TemplateEngine {
    ...
    compileTemplate(templateId, source, customHelpers, partials) {
        ...
        // built-in ones (e.g., custom 'formatDate' overrides the default)
