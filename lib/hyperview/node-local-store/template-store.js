 ...
 *
 * @see {import('../../ports/hyperview-template-store.js').HyperviewTemplateStore} HyperviewTemplateStore port
 */
export default class TemplateStore {
    ...
    constructor(options) {
        ...
        assert(options.fileSystem, 'TemplateStore fileSystem must be provided');
    ...
    async loadPartialFiles() {
        ...
        return files.filter(({ source }) => typeof source === 'string');
    }
