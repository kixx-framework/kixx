 ...
 * @property {function(string, string, Map<string, Function>, Map<string, string>): Function} compileTemplate
 ...
 *   - `partials` {Map<string, string>} — Named partial template sources available inside the template
 *
