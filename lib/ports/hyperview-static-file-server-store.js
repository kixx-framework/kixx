...
/**
 * Static file descriptor returned by HyperviewStaticFileServerStore#getFile().
 *
 * @typedef {Object} HyperviewStaticFileDescriptor
 * @property {number} sizeBytes - File size in bytes
 * @property {Date} modifiedDate - Last modification date used for conditional requests
 * @property {string|undefined} contentType - MIME type to emit when known
 * @property {function(): Promise<string>} computeHash - Computes a stable hash for cache validation / ETags
 * @property {function(): *} createReadStream - Returns a readable body stream for the file contents
 */

/**
 * @typedef {Object} HyperviewStaticFileServerStore
 * @property {function(string): Promise<HyperviewStaticFileDescriptor|null>} getFile
 *   Loads a static file by URL pathname.
 *   MUST resolve with a HyperviewStaticFileDescriptor or null; never reject
 *   for a missing file (use null to signal "not found").
 */
