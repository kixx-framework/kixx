...
/**
 * @typedef {import('./platform-utils.js').PlatformUtils} PlatformUtils
 */
 ...
 * @property {function(): PlatformUtils} createUtils
 *   Creates and returns a platform-specific utilities object implementing the PlatformUtils port.
 */
