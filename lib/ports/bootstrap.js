...
/**
 * @typedef {import('./uuid-generator.js').UUIDGenerator} UUIDGenerator
 */
 ...
 * @property {function(): UUIDGenerator} createUtils
 *   Creates and returns a platform-specific utilities object implementing the UUIDGenerator port.
 */
