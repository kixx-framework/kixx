 ...
 *
 * @property {string|Buffer|ReadableStream|import('stream').Readable|null} body
 *   Response body. Defaults to `null`. Set directly or via `respond*` methods.
 *   Accepts a string, Buffer, WHATWG ReadableStream, or Node.js Readable stream.
 *
 ...
 *   Returns `this`.
 *
 * @property {function(number, ReadableStream|import('stream').Readable|null, Object=): ServerResponse} respondWithStream
