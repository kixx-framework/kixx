...
export default class PageTemplateEngine {
     ...
     * and returns a render function. The render function can be used to generate HTML
     * by passing a context object. Optionally, partials can be included or excluded
