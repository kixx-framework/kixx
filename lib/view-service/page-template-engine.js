...
export default class PageTemplateEngine {
    ...
    constructor(options) {
        ...
        // Make a copy of the original Map so we don't modify the original.
        this.helpers = new Map(helpers);

        // Rename the noop helper to something more meaningful
        this.helpers.set('unescape', helpers.get('noop'));

        this.helpers.set('formatDate', formatDate);
        this.helpers.set('plusOne', plusOne);
     ...
     */
    createMetadataTemplate(templateId, source) {
