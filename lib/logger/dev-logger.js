...
export default class DevLogger extends BaseLogger {
    ...
    /**
     * Formats and writes a log entry via the injected printWriter. ANSI color
     * (yellow for WARN, red for ERROR) is applied only to the timestamp and level
     * prefix — not to the message body.
    ...
    printMessage(level, message, info, error) {
        ...
        this.printWriter(messageString + '\n');
