 ...
 * @emits Config#update:config - Emitted when configuration is updated via updateConfig()
 * @emits Config#update:secrets - Emitted when secrets are updated via updateSecrets()
 */
export default class Config extends EventEmitter {
     ...
     * @throws {AssertionError} When namespace is empty or equals "environments"
     */
