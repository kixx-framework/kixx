...
export default class PluginStore {
     ...
     * @returns {Promise<PluginDescriptor[]>} Array of plugin information objects
     */
     ...
     * @returns {Promise<PluginDescriptor[]>} Array of loaded plugin information with register and initialize functions
