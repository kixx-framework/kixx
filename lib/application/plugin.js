...
/**
 * @typedef {Object} UserRolesResult
 * @property {Map<string, UserRoleDefinition>} roles - Map of user role definitions keyed by role name
 */
...
export default class Plugin {
     ...
     * @async
     * @returns {Promise<UserRolesResult>} Object containing a roles Map keyed by role name
     */
    async loadUserRoles() {
