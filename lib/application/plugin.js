...
/**
 * Loads and manages plugin modules, discovering and loading collections, middleware,
 * request handlers, and error handlers from a plugin directory.
 *
...
export default class Plugin {
    ...
    constructor(fileSystem, directory) {
        ...
        /**
         * Map of loaded Collection definitions keyed by collection name.
        ...
        /**
         * Map of loaded middleware factory functions keyed by function name.
         * Populated during load().
        ...
        /**
         * Map of loaded request handler factory functions keyed by function name.
         * Populated during load().
         * @type {Map<string, Function>}
         */
        ...
        /**
         * Map of loaded error handler factory functions keyed by function name.
         * Populated during load().
         * @type {Map<string, Function>}
         */
    ...
    /**
     * Loads the plugin module and discovers all components (collections, middleware,
     * request handlers, error handlers) from the plugin directory structure.
     * @async
     ...
     * @async
     * @returns {Promise<Map<string, CollectionDefinition>>} Map of Collection definitions keyed by collection name
     */
     ...
     * @returns {Promise<Map<string, Function>>} Map of functions keyed by function name
     */
