...
export default class Context {
     ...
     * The rootUser must be set with [Context#setRootUser](#context__setrootuser)
     * during the [application initialization](./kixx-application-initialization) process.
     * @name rootUser
     * @type {User}
     * @public
     * @readonly
    ...
    /**
     * Registers a View for later access from middleware and handlers. Application developers
     * should manually register Views during application initialization to make view loading
     * more visible and explicit in their application code.
     * @public
    ...
    /**
     * Registers a Form for later access from middleware and handlers. Application developers
     * should manually register Forms during application initialization to make form loading
     * more visible and explicit in their application code.
     *
    ...
    /**
     * Registers a user role for later retrieval by the user management components. Application
     * developers should manually register user roles during application initialization to make
     * user role loading more visible and explicit in their application code.
     * @public
