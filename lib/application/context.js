...
export default class Context {
     ...
     * are automatically discovered during application initialization, there should be
     * no reason to manually register a Form unless you are customizing the app or
     * plugin initialization process.
     * @public
     ...
     * roles are automatically discovered during application initialization, there should be
     * no reason to manually register a user role unless you are customizing the app or
     * plugin initialization process.
     * @public
