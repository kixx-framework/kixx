...
const URL_ENCODED_MEDIA_TYPE = `application/x-www-form-urlencoded`;
const JSON_MEDIA_TYPE = `application/json`;

const contentTypeMap = {
	json: JSON_MEDIA_TYPE,
	jsonApi: JSON_API_MEDIA_TYPE,
	urlEncoded: URL_ENCODED_MEDIA_TYPE
};
...
module.exports = function parseBody(options = {}) {
	...
	return function parseBodyMiddleware(req, res, next) {
		...
		req.on(`end`, () => {
			if (req.is(`json`) || req.is(JSON_API_MEDIA_TYPE)) {
