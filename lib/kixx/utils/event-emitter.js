 ...
 *
 * Handlers registered with on() persist across emits. Handlers registered with
 * once() fire once on the next emit then are automatically removed.
 *
 * @module EventEmitter
 */
export default class EventEmitter {
    ...
    /**
     * Registers a handler that is removed before the next matching event is delivered.
     * @param {*} eventName - Event key used to identify emitted events.
     * @param {Function} handler - Callback invoked with the emitted payload.
     * @returns {EventEmitter} This emitter instance for chaining.
     */
     ...
     * @returns {EventEmitter} This emitter instance for chaining.
     * @throws {Error} Re-throws any error thrown by a handler.
     */
