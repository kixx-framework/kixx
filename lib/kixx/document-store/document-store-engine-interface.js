 ...
 *   `update()`.
 * - `update()` MUST reject when the target document is missing or the stored
 ...
 * @property {string} [cursor] - Opaque pagination cursor from a previous page.
 ...
 *   Deletes one document by type and id. When a positive version is provided,
 *   the delete MUST use optimistic concurrency and reject when the document is
 *   missing or the stored version differs. Without a positive version, returns
