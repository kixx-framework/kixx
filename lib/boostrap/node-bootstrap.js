 ...
 * @property {function(ApplicationContext): void} register - Registers plugin components with the application context
 * @property {function(ApplicationContext): Promise<void>} initialize - Performs async plugin initialization
 */
