...
export default class KixxBaseCollection {
     ...
     *
     * @param {ApplicationContext} context - Application context providing access to services
     */
    constructor(context) {
        const Model = this.constructor.Model;

        assert(context, 'A Collection requires an ApplicationContext');
        ...
        Object.defineProperties(this, {
            ...
            logger: {
                value: context.logger.createChild(this.constructor.name),
            },
        });
    }
