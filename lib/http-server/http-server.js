...
/**
 * HttpServer debug event.
 * @event HttpServer#debug
 * @type {Object}
 * @property {string} name - Event name identifier
 * @property {string} message - Human-readable event description
 * @property {Object} info - Additional event context data
 ...
 * @emits HttpServer#error - Server errors, request errors, or handler errors
 * @emits HttpServer#info - Server lifecycle events (listening, closed)
 * @emits HttpServer#debug - Request/response activity for debugging
 */
