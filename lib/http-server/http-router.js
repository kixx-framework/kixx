...
export default class HttpRouter extends EventEmitter {
     ...
     */
    async handleHttpRequest(appContext, request, response) {
        let target = null;
        let route = null;
     ...
     * @returns {[HttpRoute, Object, Object, VirtualHost]} Route, hostname params, pathname params, and virtual host
    ...
    matchRequest(request) {
        ...
        if (route && pathnameParams) {
            return [ route, hostnameParams, pathnameParams, vhost ];
        }
