...
export default class HttpRoute {
     ...
     * @param {string} options.pattern - Pattern that matches a pathname.
    ...
    /**
     * Finds the first HttpTarget associated with this route which
     * allows the HTTP method of the request.
     *
     ...
     * Returns the first non-falsy response returned by a handler,
     * or false if none handle the error.
     *
