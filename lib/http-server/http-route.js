...
export default class HttpRoute {
     ...
     *
     * Takes a target name and pathname parameters, then compiles them into a
     * concrete pathname and selects the preferred HTTP method for that target.
     *
     * @param {string} targetName - Name of the target on this route
     ...
     */
    compileTargetPathname(targetName, params) {
        if (this.#pattern === '*') {
