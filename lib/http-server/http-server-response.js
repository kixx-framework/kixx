...
/**
 * @typedef {Object} UTF8ResponseOptions
 * @property {string} [contentType] - Custom content type header value
 */
...
export default class HttpServerResponse {
    ...
    /**
     * Sets a header on the response. If the header already exists, it will replace it.
    ...
    /**
     * Append a header on the response. If the header already exists it will be appended.
     * @param {string} key - The header name
     * @param {string} val - The header value
     * @returns {HttpServerResponse} This response instance for method chaining
     */
     ...
     * @returns {HttpServerResponse} This response instance for method chaining
     * @throws {AssertionError} When statusCode is not a valid number
    ...
    /**
     * Configures the response to return UTF-8 encoded content with proper content type and encoding.
     * Automatically sets Content-Type, Content-Length, and UTF-8 encoding headers.
     * @param {number} statusCode - HTTP status code for the response
     * @param {string} utf8 - UTF-8 encoded string content for the response body
     * @param {UTF8ResponseOptions} [options] - UTF-8 response configuration options
     * @returns {HttpServerResponse} This response instance for method chaining
     * @throws {AssertionError} When statusCode is not a valid number
     * @throws {AssertionError} When utf8 is not a non-empty string
     */
