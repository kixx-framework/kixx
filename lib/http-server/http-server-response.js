...
export default class HttpServerResponse {
    ...
    respond(statusCode, headers, body) {
        ...
        if (headers) {
            // Support Headers instance, plain object, or array of [key, value] tuples
            let entries;
    ...
    respondWithJSON(statusCode, obj, options) {
        ...
        // Use respondWithUtf8 with application/json content type
        this.respondWithUtf8(statusCode, utf8, {
            contentType: 'application/json',
            headers: options.headers,
        });

        // If custom contentType provided, override (respondWithUtf8 appends charset, but custom may not want it)
