...
export default class HttpServerResponse {
    ...
    constructor(id) {
        ...
        /**
         * The response body. Can be string, Buffer, stream, etc.
         * @type {*}
         */
        this.body = null;
     ...
     * Custom properties for passing data between middleware handlers.
     * @public
     * @returns {Object} Mutable properties object shared across middleware
     */
    get props() {
        return this.#props;
    }
    ...
    respondWithRedirect(statusCode, newLocation, options) {
        ...
        if (newLocation && typeof newLocation.href === 'string') {
    ...
    /**
     * Merges headers from various formats into this response's headers.
     * @param {Object|Headers|Array<[string,string]>} headers - Headers to merge (object, Headers instance, or entries array)
     */
