...
import { NotFoundError, WrappedError } from '../errors/mod.js';
...
export default function PageHandler(options) {
    ...
    return async function pageHandler(context, request, response) {
        ...
        const cause = new Error('This is a test error');
        throw new WrappedError('Error hydrating page data', { name: 'RequestError', code: 'HYDRATING_ERROR', cause });
