 ...
 *
 * @emits JSModuleConfigStore#update:config - Emitted when configuration is loaded via loadConfig()
 * @emits JSModuleConfigStore#update:secrets - Emitted when secrets are loaded via loadSecrets()
 */
export default class JSModuleConfigStore {
    ...
    /**
     * @param {Object} options - JSModuleConfigStore initialization options
    ...
    constructor(options) {
        ...
        assert(config, 'JSModuleConfigStore config must be provided');
     ...
     * @returns {JSModuleConfigStore} This instance for chaining
     */
