...
/**
 * @typedef {import('../ports/platform-utils.js').PlatformUtils} PlatformUtils
 */
...
export default class ApplicationContext {
     ...
     * @param {PlatformUtils} options.utils - Platform-specific utility functions
     */
    constructor({ runtime, config, logger, utils }) {
        Object.defineProperties(this, {
             ...
             * UUID generation and cryptographic hashing. The shape is defined by the PlatformUtils
             * port so the same application code works across Node.js, Cloudflare Workers,
             * and other runtimes.
             * @name utils
             * @public
             * @type {PlatformUtils}
    ...
    /**
     * Returns the registries used to resolve router definitions.
     *
     * This method is intended for router assembly code and allows route
     * definitions to resolve middleware, request handlers, and error handlers
     * by name.
     *
     * @public
     * @returns {Object}
     * @returns {Map<string, Function>} returns.middleware
     * @returns {Map<string, Function>} returns.requestHandlers
     * @returns {Map<string, Function>} returns.errorHandlers
     */
    getHttpRouterRegistries() {
        return {
