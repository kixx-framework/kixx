...
/**
 * Store interface for loading virtual host and route specifications. HttpRouter uses it to load
 * specs and build VirtualHost instances when handling requests or reloading routes.
 *
 * @typedef {Object} HttpRoutesStore
 * @property {function(): Promise<Array<VirtualHostSpec>>} loadVirtualHosts - Loads virtual host
 *   specifications for building VirtualHost instances
 */
