...
export function findLeftmostPositionAscending(sortedList, target) {
    ...
    while (left < right) {
        ...
        // If current element is less than target, we need to search right
        // This maintains the invariant that all elements left of 'left' are < target
    ...
    // When left == right, we've found the leftmost insertion point
    return left;
}
...
export function findRightmostPositionAscending(sortedList, target) {
    ...
    while (left < right) {
        ...
        // If current element <= target, we need to search right
        // This maintains invariant: all elements left of 'left' are <= target
...
export function findLeftmostPositionDescending(sortedList, target) {
    ...
    while (left < right) {
        ...
        // If current element > target, search right (descending order)
        // This maintains invariant: all elements left of 'left' are > target
