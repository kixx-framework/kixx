...
export default class DataStore {
     ...
     * @param {boolean} [options.descending=false]      - Descending index order.
    ...
    async query(type, options) {
        ...
        const hasLower = greaterThan !== undefined || greaterThanOrEqualTo !== undefined;
        const hasUpper = lessThan !== undefined || lessThanOrEqualTo !== undefined;
        ...
        if (greaterThan !== undefined && greaterThanOrEqualTo !== undefined) {
            err.push('greaterThan and greaterThanOrEqualTo are mutually exclusive', 'options');
        }
        if (lessThan !== undefined && lessThanOrEqualTo !== undefined) {
            err.push('lessThan and lessThanOrEqualTo are mutually exclusive', 'options');
        }
