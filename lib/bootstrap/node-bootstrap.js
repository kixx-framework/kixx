...
import JSModuleHttpRoutesStore from '../http-routes-stores/js-module-http-routes-store.js';
 ...
 *
 * Inject an instance of this class into ApplicationAssembler to wire up a Kixx
 ...
 * switching platforms requires only swapping the bootstrap passed to ApplicationAssembler.
 *
...
export default class NodeBootstrap {
     ...
     * @returns {JSModuleHttpRoutesStore}
     */
    createHttpRoutesStore(vhostsConfigs) {
        return new JSModuleHttpRoutesStore(vhostsConfigs);
    }
