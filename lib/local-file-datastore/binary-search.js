...
/**
 * Returns true if comp is greater than val using the same comparison as compare().
...
/**
 * Returns true if comp is greater than or equal to val using the same comparison as compare().
 * @param {*} comp - Value to compare
 * @param {*} val - Value to compare against
 * @returns {boolean}
 */
...
/**
 * Returns true if comp is less than val using the same comparison as compare().
 * @param {*} comp - Value to compare
 * @param {*} val - Value to compare against
 * @returns {boolean}
 */
...
/**
 * Returns true if comp is less than or equal to val using the same comparison as compare().
 * @param {*} comp - Value to compare
 * @param {*} val - Value to compare against
 * @returns {boolean}
 */
