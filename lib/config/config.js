...
export default class Config {
    ...
    constructor(store, environment, applicationDirectory) {
        assertNonEmptyString(environment, 'Config environment must be a non-empty string');
        // TODO: We need to assert the store and the applicationDirectory
        ...
        Object.defineProperties(this, {
            ...
            // TODO: The environment and name properties should be defined here as well.
        });
    }
